...
const CreatePage = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-linear-to-b from-purple-900 via-pink-900 to-orange-900">
      ...
      <div className="absolute bottom-20 right-20 w-96 h-96 bg-cyan-500 rounded-full blur-[128px] opacity-30 animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      {/* Scanline effect */}
      <div className="pointer-events-none absolute inset-0 bg-linear-to-b from-transparent via-pink-500/5 to-transparent animate-[scan_8s_linear_infinite]" style={{
